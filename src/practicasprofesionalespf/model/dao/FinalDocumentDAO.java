...
public class FinalDocumentDAO {
    public static ArrayList<FinalDocument> obtainFinalDocument(int idRecord) throws SQLException{
        ...
        String sqlQuery = "SELECT f.idFinalDocument, f.name, f.date, f.filePath FROM FinalDocument "
                + "f JOIN Delivery d ON f.idFinalDocument = d.idFinalDocument WHERE d.idRecord = ?;";
