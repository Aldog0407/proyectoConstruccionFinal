...
public class FXMLLoginController implements Initializable {
    ...
    private void validateCredentials(String username, String password){
        try{
            ...
            Utils.showSimpleAlert(Alert.AlertType.ERROR, "Problemas de conexión", "Hubo un problema al intentar conectar con la base de datos.");
        }
    }
    ...
    private void goToHomepage(String fxmlPath){
        try{
            ...
            Parent view = FXMLLoader.load(PracticasProfesionalesPF.class.getResource(fxmlPath));
    ...
    private Student obtainStudent(int idUser){
        ...
        try {
            ...
            Utils.showSimpleAlert(Alert.AlertType.ERROR, "Error de conexión", "No se pudo realizar el inicio de sesión por problemas en la base de datos");
        }
        return student;
    }
