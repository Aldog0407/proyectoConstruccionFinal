...
public class FXMLPickDocumentController implements Initializable {
    ...
    private void goToValidateDocument(DocumentWrapper document){
        try {
            ...
            controller.initializeData(student, document, projectName);
    ...
    private void onCancelButtonClicked(ActionEvent event) {
        WindowUtils.whenCancelClicked(tvDocuments);
    }
